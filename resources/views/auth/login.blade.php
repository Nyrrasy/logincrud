                    ...
                    <div class="row g-0">
                        ...
                        <div class="card-body p-md-5 mx-md-4">
                          ...
                          <form action="route('login')" method="post">
                            ...
                            <div class="text-center pt-1 mb-5 pb-1">
                              ...
                              <br><a class="text-muted" href="#!">olvido su contraseña?</a>
                            </div>
          
                            <div class="d-flex align-items-center justify-content-center pb-4">
                              <p class="mb-0 me-2">No tiene una cuenta?</p>
                              <a  href="{{route('register')}}" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-danger">Registrese</a>
                            </div>
                      ...
                      <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                        <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                          <h4 class="mb-4">Proyecto crud</h4>
                          <p class="small mb-0">El es proyecto de control de tareas con la finalidad de crear y modificar 
                            dichas tareas en el momento que usted desee
                          </p>
                        </div>
                      </div>
                    </div>
